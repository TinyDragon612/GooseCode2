...
public class AutonWild extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder traj2 = drive.actionBuilder(initialPose)
                ...
                .afterTime(1, robot.wall()) //1.5
                .strafeToConstantHeading(new Vector2d(75, -75))
                .afterTime(1.05, robot.closeBack())
                .afterTime(1.2, robot.wallBump())
                .waitSeconds(2)
        ...
        //Actions.runBlocking(robot.extendIn());
        ...
        while (opModeIsActive() && !isStopRequested()){
            telemetry.addData("les gooooooo", "yay");
            telemetry.update();
            //Actions.runBlocking(robot.extendIn());
            if(opModeIsActive()){
                Actions.runBlocking(
